...
const TopDoctors = () => {
  ...
  const { doctors } = useContext(AppContext) // Using useContext to access the doctors data from AppContext
...
*/}
        {doctors.slice(0, 10).map((item, index) => (    /* This slice function allows only 10 doctors to be displayed */
