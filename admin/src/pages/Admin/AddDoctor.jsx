...
const AddDoctor = () => {
    ...
    const onSubmitHandler = async (event) =>{
        ...
        try{
            ...
            formData.append('image',docImg) //same name image as in the backend
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <button type='submit' className='bg-[#5F6FFF] text-white px-10 py-3 rounded-full mt-4 '>Add doctor</button>
            </div>
        </form>
    )
}
